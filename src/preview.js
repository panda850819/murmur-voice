...
// Cache segmenter for performance (Intl.Segmenter instantiation is expensive)
...
function wordDiff(original, edited) {
  // Apply bulk lowerCase to the original string prior to tokenization to avoid mapping over intermediate arrays.
